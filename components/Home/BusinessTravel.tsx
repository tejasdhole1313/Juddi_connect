...
//   useEffect(() => {
//     const hasbusinessAnimationPlayed = sessionStorage.getItem(
//       "businessAnimationPlayed"
//     );

//     // if (pathname === "/" && !hasbusinessAnimationPlayed) {
//     if (!hasbusinessAnimationPlayed) {
...
//       sessionStorage.setItem("businessAnimationPlayed", "true");
//       setHasAnimatedBefore(false);
//     } else {
//       // Directly set the final state
...
//         >
//           All-in-one solution for simplifying your business travel, including
//           domestic and international flights and accommodation.
//         </motion.p>

//         <Link href="/business-travel">
//           <motion.button
...
export default function BusinessTravel() {
  ...
  return (
    <section className="flex justify-center items-center p-6 md:px-8 lg:px-12 relative group">
      ...
      <div
        ref={heroBg1}
        // className="w-[10%] h-[20%] bg-[#7291CA] absolute z-0"
